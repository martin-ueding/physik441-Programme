...
def main():
    ...
    pl.loglog(data[:, 0], data[:, 1], label=ur"$\phi_1$", **plotargs)
    pl.loglog(data[:, 0], data[:, 2], label=ur"$\phi_2$", **plotargs)
    pl.loglog(data[:, 0], data[:, 3], label=ur"$p_1$", **plotargs)
    pl.loglog(data[:, 0], data[:, 4], label=ur"$p_2$", **plotargs)
    ...
    pl.loglog(data[:, 1], data[:, 3], label=ur"1", **plotargs)
    pl.loglog(data[:, 2], data[:, 4], label=ur"2", **plotargs)
    pl.title(ur"Doppelpendel mit Runge-Kutta")

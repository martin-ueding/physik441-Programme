...
def main():
    ...
    pl.plot(data[:, 0], data[:, 1], label=ur"$\phi_1$", **plotargs)
    pl.plot(data[:, 0], data[:, 2], label=ur"$\phi_2$", **plotargs)
    pl.plot(data[:, 0], data[:, 3], label=ur"$p_1$", **plotargs)
    pl.plot(data[:, 0], data[:, 4], label=ur"$p_2$", **plotargs)
    pl.plot(data[:, 0], data[:, 5], label=ur"$H$", **plotargs)

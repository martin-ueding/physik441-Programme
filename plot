...
def main():
    ...
    pl.plot(data[:, 0], data[:, 3], label=ur"$\omega_1$", color="blue", linestyle="--")
    pl.plot(data[:, 0], data[:, 4], label=ur"$\omega_2$", color="green", linestyle="--")
    ...
    pl.ylabel(ur"Winkelgeschwindigkeit $\omega_i$")
    pl.grid(True)
    pl.legend(loc="best")
    ...
    print ur"Zeitentwicklung -- Doppelpendel mit Cash-Carp"
    data = np.genfromtxt("out/3-cc-higher.txt")
    pl.plot(data[:, 0], data[:, 1], label=ur"$\phi_1$", color="blue", linestyle="-")
    pl.plot(data[:, 0], data[:, 2], label=ur"$\phi_2$", color="green", linestyle="-")
    pl.plot(data[:, 0], data[:, 3], label=ur"$\omega_1$", color="blue", linestyle="--")
    pl.plot(data[:, 0], data[:, 4], label=ur"$\omega_2$", color="green", linestyle="--")
    ...
    pl.grid(True)
    pl.legend(loc="best")
    pl.savefig("out/3-cc-higher-zeit.pdf")
    pl.savefig("out/3-cc-higher-zeit.png")
    pl.clf()
    ...
    pl.grid(True)
    pl.legend(loc="best")
    pl.savefig("out/3-cc-higher-phase.pdf")
    pl.savefig("out/3-cc-higher-phase.png")
    pl.clf()
